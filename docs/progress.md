...
## 2026-08-16 · 第1课课文包（OCR+校对）+ 收尾（目标长跑第 4 轮）

- 扫描版 PDF 定位第一课正文（pdf 第 12-14 页，449 页总书），OCR 质量高；课文对话逐句人工校对后做成课文包 a1-moderno-1-texto（词汇 8 + 听辨 8 + 句型 10）。
...
## 2026-08-16 · 第 7 课课文包 + 教材 1-7 课全入库（目标长跑里程碑）
