...
`v0.7.1` · 20 个学习包 · 243 词汇 · 165 听辨对 · 211 句型 · 1570 段音频 · 零依赖
...
→ 第6-7课（学案+课文×2）→ 第8-9课（学案）→ 第9-10课（旧版补充）→ 复习课（颜色与家庭）
→ （通用示例包排最后）
```

- 20 个学习包，每包：词汇 8-32 + 听辨 7-9 对 + 句型 8-21 句
- 1570 段音频（edge-tts 微软神经语音 `es-ES-ElviraNeural`，常速 + 慢速双档）
...
| v0.7.1 | 内容更新：第 8-9 课学案 / 旧版 9-10 补充 / Repaso 复习课入库（20 包） | ✅ 2026-08-29 |
...
完整版本迭代历史（v0.1 → v0.7.1）见 **[CHANGELOG.md](CHANGELOG.md)**。
